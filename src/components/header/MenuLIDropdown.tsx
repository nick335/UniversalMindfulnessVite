...
const MenuLIDropdown = () => {
  ...
  return (
    <div
      className={`flex flex-col gap-y-[1.12rem] font-semibold text-xl text-headerSecondary h-[2.6125rem]  overflow-hidden ${hasInteracted ? (aboutDropdown ? 'animate-dropDownAni' : 'animate-goBackUpAni') : ''} lg:animate-none lg:text-textPrimary lg:h-fit lg:relative lg:text-base lg:overflow-visible`}
