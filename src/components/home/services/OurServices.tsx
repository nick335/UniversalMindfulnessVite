  ...
  return (
    <section className='mt-[2.92rem] lg:mt-16'>
        <Subheader header='our services' />
          <motion.div ref={parentRef} variants={parentVariants} initial="hidden" animate={controls} exit="hidden" className='xsm:grid xsm:grid-cols-2 xsm:gap-x-6 md:gap-x-12 lg:gap-x-16 xl:gap-x-20 w-full' >
            {
              isLoading ?
