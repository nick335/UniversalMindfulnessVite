  ...
  return (
    <div className='mt-[0.7rem] min-w-full max-w-full overflow-hidden lg:flex lg:items-center lg:gap-x-10'>
      <div className='flex gap-x-[0.77rem] items-start font-inter  lg:gap-x-[1.21rem]'>
        <img src={quote} className='object-fill w-[1.74294rem] h-[1.46281rem] lg:w-[2.80206rem] lg:h-[2.35175rem]' alt='quote' />
        <div>
          ...
          <div className='mt-3.5'>
            ...
            <h5 className='text-[0.66769rem] font-medium lg:max-w-[90%] lg:text-wrap'>{caption}</h5>
          </div>
        </div>
      </div>
