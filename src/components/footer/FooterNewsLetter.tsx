    ...
    <div className='max-w-[80%] mx-auto min-w-[16.875rem] w-full lg:mx-0 lg:max-w-[90%]'>
      ...
      <form>
        <div className='p-[0.33rem] border-none border-inputBorder bg-inputBg rounded-md flex gap-x-3 '>
          ...
          <button className='h-[2.38125rem] min-w-[5.06388rem] btn-sec bg-white text-textSecondary font-semibold rounded-md' onClick={handleSubscribeToNewsLetter} >Sign Up</button>
        </div>
      </form>
    </div>
  )
